...
<head>
  ...
  <title>LEGEND SATIFAN BAAP </title>
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css">
  <style>
    label { color: white; }
    body {
      background-image: url('https://i.ibb.co/Nd6ST730/FB-IMG-1761122887622.jpg');
...
<body>
  ...
  <footer class="footer">
    <p>SATIFAN BAAP S3RV3R</p>
    <p>ALWAYS ON FIRE SATIFAN BAAP</p>
    <div class="mb-3">
